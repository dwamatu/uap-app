...
<head>
    ...
    <!-- Pace loader -->
    <link rel="stylesheet"
          href="https://cdnjs.cloudflare.com/ajax/libs/pace/1.0.2/themes/silver/pace-theme-center-circle.min.css">
                ...
                <!-- user dropdown links -->
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                           aria-expanded="false" title="User Information">
...
<div class="container">
    <p class="text-muted">{{ date('Y') }} Tangerine Software</p>
    <br/>
</div>
