...
class CompanyUtilities {
    ...
    public static function createCompany($content) {
        unset($content['_token']);
//        dd(collect($content)->toJson());
        return json_decode(ApiUtilities::IssuePOSTRequest("http://139.59.30.157:3050/api/mtandao/mkoposalo/registercompany", collect($content)->toJson()), true);
    }
    ...
    public static function getCompanies() {
        ...
        $apiUrl = "http://139.59.30.157:3050/api/mtandao/mkoposalo/companyinfoall";
